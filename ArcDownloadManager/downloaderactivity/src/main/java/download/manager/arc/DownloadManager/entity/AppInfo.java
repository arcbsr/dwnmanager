package download.manager.arc.DownloadManager.entity;
...
public class AppInfo implements Serializable {
    ...
    public String getSdPathFolder() {
        return sdPathFolder;
    }

    private String sdPathFolder;
    private String id;
    ...
    public AppInfo(String id, String name, String image, String url, String extension, String pathToSave) {
        this.name = name;
        this.id = id;
        this.image = image;
        this.url = url;
        this.extension = extension;
        this.sdPathFolder = pathToSave;
    }
